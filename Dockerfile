...
RUN apk add composer dumb-init icu-data-full php81-apache2 php81-gd php81-imap php81-intl php81-mysqli php81-pecl-imagick php81-pecl-redis php81-pecl-memcached php81-sockets php81-tokenizer php81-xml php81-zip tzdata
